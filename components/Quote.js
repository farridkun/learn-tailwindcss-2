function Quote() {
  return (
    <div className="bg-white transform rotate-3 hover:rotate-0 transition-all duration-200 shadow-xl hover:shadow rounded-xl overflow-hidden">
      <div className="px-8 py-5 leading-relaxed text-xl text-grey-800">
        ...
        inventore laborum dicta quis voluptas impedit in quasi repellendus
        ipsam.
      </div>
      <div className="px-8 py-5 bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-between">
        <div className="flex items-center">
          <div className="flex-shrink-0 mr-3">
            <img
              className="w-10 h-10 rounded-full border-2 border-white"
              src="https://assets.gitlab-static.net/uploads/-/system/user/avatar/7580842/avatar.png?width=90"
              alt="Farrid Kuntoro"
            />
          </div>
          <div className="text-white">Farrid Kuntoro</div>
        </div>
        <a
          href="#"
          className="text-white text-opacity-25 hover:text-opacity-75"
        >
